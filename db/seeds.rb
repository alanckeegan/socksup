...
Listing.create!(title: 'Bartender',hours_per_week: 20, start_date: '01-12-2018'.to_datetime, end_date: '31-12-2018'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: linekers.id, quiz_id: linkersquiz.id, photo: 'https://images.unsplash.com/photo-1515674213736-54d14b4285b4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80')
Listing.create!(title: 'Hostess',hours_per_week: 30, start_date: '01-01-2019'.to_datetime, end_date: '31-01-2019'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: linekers.id, quiz_id: linkersquiz.id, photo: 'https://images.unsplash.com/photo-1453614512568-c4024d13c247?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=01be54aef2c30ab337248a5bc1439602&auto=format&fit=crop&w=1789&q=80')
Listing.create!(title: 'PR',hours_per_week: 25, start_date: '01-12-2018'.to_datetime, end_date: '31-12-2018'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: linekers.id, quiz_id: linkersquiz.id, photo: 'https://images.unsplash.com/photo-1525857332689-4b3110c2d3f3?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=64092aab3ca44d0dd8f1314166dba348&auto=format&fit=crop&w=1256&q=80')
Listing.create!(title: 'Bartender',hours_per_week: 40, start_date: '01-01-2019'.to_datetime, end_date: '31-01-2019'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: smokehouse.id, quiz_id: smokehousequiz.id, photo: 'https://images.unsplash.com/photo-1468072114808-903e572b8ead?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1332&q=80')
Listing.create!(title: 'Waitress',hours_per_week: 20, start_date: '01-12-2018'.to_datetime, end_date: '31-12-2018'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: smokehouse.id, quiz_id: smokehousequiz.id, photo: 'https://images.unsplash.com/photo-1511421616335-5a9846f1afcb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1789&q=80')
Listing.create!(title: 'Pot wash',hours_per_week: 30, start_date: '01-01-2019'.to_datetime, end_date: '31-01-2019'.to_datetime, description: 'Looking for an enthusiastic worker',  employer_id: smokehouse.id, quiz_id: smokehousequiz.id, photo: 'https://images.unsplash.com/photo-1470114755716-3e1124c6c3bd?ixlib=rb-0.3.5&s=804af933165df2475beefbd57c0634db&auto=format&fit=crop&w=1588&q=80')
puts 'Finished!'
