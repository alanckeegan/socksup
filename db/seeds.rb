...
alan = User.create!(first_name: "Alan", last_name: "Keegan", email: 'alan@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/alan.jpg')
marina = User.create!(first_name: "Marina", last_name: "Kjaer", email: 'marina@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/marina.png')
annie = User.create!(first_name: "Annie", last_name: "Gilchirst", email: 'annie@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/annie.png')
jascha = User.create!(first_name: "Jascha", last_name: "Drel", email: 'jascha@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/jascha.png')


puts 'Creating 3 employers...'
nvc = Employer.create!(name: 'NVC', city: 'Barcelona', description: 'A fun local bar which offers many drinks including cocktails and has a delicious pizza kitchen and a pool table', address: '334 Carrer de Roger de Flor', contact: 'nvc@socksup.co.uk', photo: 'https://res.cloudinary.com/demo/image/upload/bar1.jpg')
sutton = Employer.create!(name: 'Sutton', city: 'Barcelona', description: 'Everyones favourite club', address: '16, Carrer de Tuset', contact: 'sutton@socksup.co.uk', photo: 'https://res.cloudinary.com/demo/image/upload/sutton.png')
sunsetgrill = Employer.create!(name: 'Sunset Grill',description: 'The open-sided eatery serves up high-quality grilled dishes with a stunning backdrop of the sun sinking into to Andaman Sea, all in a chic and romantic setting.', address: '16 Carrer del Call',city: 'Barcelona', contact: 'sunsetgrill@socksup.co.uk', photo: 'https://res.cloudinary.com/demo/image/upload/restaurant.jpg')
...
pierre = User.create!(first_name: "Pierre", last_name: "Herve-Bazin", email: 'pierre@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/pierre.jpg', employer_id: sutton.id)
lucas = User.create!(first_name: "Lucas", last_name: "Rocha", email: 'lucas@socksup.co.uk', password: '123456', photo: 'https://res.cloudinary.com/demo/image/upload/lucas.jpg', employer_id: nvc.id)
...
hostesssutton = Listing.create!(title: 'Hostess',hours_per_week: 20, pay_per_hour: 10, start_date: '01-05-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented hostess for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sutton.id, quiz_id: suttonquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/club2.jpg')
waiternvc = Listing.create!(title: 'Waiter',hours_per_week: 20, pay_per_hour: 9, start_date: '01-06-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented waiting bartenders for our cosy bar which prides itsef in serving local coding bootcamp students. Casual flexible position.',  employer_id: nvc.id, quiz_id: nvcquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/mnwonmbyt38z8obpfg4p.jpg')
baristanvc = Listing.create!(title: 'Barista',hours_per_week: 15, pay_per_hour: 8, start_date: '01-06-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented barrista for our cosy bar which prides itsef in serving local coding bootcamp students. Casual flexible position.',  employer_id: nvc.id, quiz_id: nvcquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/barista1.jpg')
pizzanvc = Listing.create!(title: 'Pizza Chef',hours_per_week: 30, pay_per_hour: 8, start_date: '01-06-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented waiting bartenders for our cosy bar which prides itsef in serving local coding bootcamp students. Casual flexible position.',  employer_id: nvc.id, quiz_id: nvcquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/pizza.jpg')
babysittersunset = Listing.create!(title: 'Babysitter',hours_per_week: 20, pay_per_hour: 10, start_date: '01-06-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented babysitter to look after our local coding bootcamp students after their long days of coding, their brians have minimal funcionality. Casual flexible position.',  employer_id: sunsetgrill.id, quiz_id: sunsetgrillquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/babysitting.jpg')
headbarsutton = Listing.create!(title: 'Head Barman',hours_per_week: 30, pay_per_hour: 12, start_date: '01-06-2019'.to_datetime, end_date: '01-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented head bartender for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sutton.id, quiz_id: suttonquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/bartender2.jpg')
barbacksunset = Listing.create!(title: 'Bar back',hours_per_week: 35, pay_per_hour: 7, start_date: '01-05-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented hostess for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sunsetgrill.id, quiz_id: sunsetgrillquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/bartender1.jpg')
bartendernvc = Listing.create!(title: 'Bartender',hours_per_week: 20, pay_per_hour: 8, start_date: '05-07-2019'.to_datetime, end_date: '05-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented waiting bartenders for our cosy bar which prides itsef in serving local coding bootcamp students. Casual flexible position.',  employer_id: nvc.id, quiz_id: nvcquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/bartender3.jpg')
barbacksutton = Listing.create!(title: 'Bar back',hours_per_week: 25, pay_per_hour: 7, start_date: '01-06-2019'.to_datetime, end_date: '31-07-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented barback for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sutton.id, quiz_id: suttonquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/club1.jpg')
cocktailsunset = Listing.create!(title: 'Bar/Cocktail Master',hours_per_week: 35, pay_per_hour: 12, start_date: '01-05-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented hostess for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sunsetgrill.id, quiz_id: sunsetgrillquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/cocktail.jpg')
bartendersunset = Listing.create!(title: 'Bartender',hours_per_week: 35, pay_per_hour: 9, start_date: '01-05-2019'.to_datetime, end_date: '31-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented bartender for our amazing restuarant which prides itsef in serving local coding bootcamp students delicious cocktails. Casual flexible position.',  employer_id: sunsetgrill.id, quiz_id: sunsetgrillquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/bartender1.jpg')
barmaidsutton = Listing.create!(title: 'Bar Maid',hours_per_week: 25, pay_per_hour: 11, start_date: '15-06-2019'.to_datetime, end_date: '15-08-2019'.to_datetime, description: 'We are looking for reliable, personable, well presented waiting bartenders for our amazing club which prides itsef in telling local coding bootcamp students they are not dressed well enough to enter. Casual flexible position.',  employer_id: sutton.id, quiz_id: suttonquiz.id, photo: 'https://res.cloudinary.com/demo/image/upload/waiter1.jpg')
